...
let virtual-env = "C:\Рабочий стол\python_221\first_project\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Рабочий стол\python_221\first_project\venv\Scripts\deactivate.nu"
